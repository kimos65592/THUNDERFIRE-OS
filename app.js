...
function understand(input) {
  ...
  if (containsAny(n, ["من دلوقتي", "من الان", "غير سلوكك", "غير طريقه تفكيرك", "قبل ما تاخد قرار"])) {
    return { type: Intent.BEHAVIOR, confidence: 0.90 };
  }
...
const CognitiveEngine = {
  ...
  handleBehavior(text) {
    ...
    if (containsAny(n, ["ثلاث خطط", "3 خطط", "ثلاثه خطط"])) {
