...
/* =========================================================
   AI PROVIDER CALL
   Gemini uses Google's OpenAI-compatible Chat Completions API.
   This keeps the existing JARVIS agent/tool loop intact.
========================================================= */
...
async function callAI(
    ...
    /*
     * Gemini's OpenAI-compatible endpoint supports
     * function calling. We deliberately do not inject
     * Groq's browser_search tool here.
     *
     * Current web requests are handled by JARVIS's
     * fallback search watchdog.
     */

    if (
        AI_CONFIG.parallelToolCalls !==
        undefined
    ) {
